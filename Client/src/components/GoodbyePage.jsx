...
export default function GoodbyePage() {
  ...
  // If we don't have both, we won't be able to rejoin
  // const canRejoin = Boolean(roomID && mode);

  // const handleRejoin = () => {
  //   if (!canRejoin) return;
  //   // navigate back into the video page with the same roomID & mode
  //   navigate(`/video?roomID=${roomID}&mode=${mode}`);
  // };
